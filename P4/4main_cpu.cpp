// =====================================================================
// VITS Text Encoder - Part 4: CPU 對照版 (main_cpu.cpp)
// Advanced Computer Architecture Final Project
//
// 用途: 與 main.cu (GPU 版) 對照
//   - 相同的確定性測資 (init_deterministic + 相同 salt) -> sum 可直接比對
//   - 計時 CPU forward, 與 GPU time 對照算 speedup
//
